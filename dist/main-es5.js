...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService.prototype.login = function (username, password) {
        var _this = this;
        var user = new _app_models__WEBPACK_IMPORTED_MODULE_6__["User"]();
    ...
    AuthenticationService.prototype.register = function (username, password, role, firstName, lastName, department, address, phone) {
        var user = new _app_models__WEBPACK_IMPORTED_MODULE_6__["User"]();
        user.username = username;
        user.password = password;
        user.role = role;
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.requestRegister = function (request) {
    ...
    UserService.prototype.getUserById = function (user) {
    ...
    UserService.prototype.activateUsers = function (user) {
    ...
    UserService.prototype.dActivateUsers = function (user) {
    ...
    UserService.prototype.getRequest = function (request) {
    ...
    UserService.prototype.activateRequest = function (request) {
    ...
    UserService.prototype.dActivateRequest = function (request) {
...
var AddUserComponent = /** @class */ (function () {
    function AddUserComponent(formBuilder, authenticationService) {
    ...
    AddUserComponent.prototype.selectRights = function (event) {
        this.selectedRole = event.target.value;
    };
    AddUserComponent.prototype.selectDeparture = function (event) {
    ...
    AddUserComponent.prototype.onSubmit = function () {
        ...
        this.authenticationService.register(this.f.username.value, this.f.password.value, this.selectedRole, this.f.name.value, this.f.lastName.value, this.selectedDepartment, this.f.address.value, this.f.phone.value).subscribe(function (reponse) {
...
var AdminComponent = /** @class */ (function () {
    ...
    AdminComponent.prototype.editUser = function (user) {
        console.log(user.id);
        var navigationExtras = { state: { example: user.id } };
...
var EditUserComponent = /** @class */ (function () {
    ...
    EditUserComponent.prototype.selectRights = function (event) {
        this.selectedRole = event.target.value;
    };
    EditUserComponent.prototype.selectDeparture = function (event) {
        this.selectedDepartment = event.target.value;
    };
    EditUserComponent.prototype.ngOnInit = function () {
        ...
        var sub = this.route
            ...
            _this.idCurrent = params['serviceId'];
        });
        var user = new _app_models__WEBPACK_IMPORTED_MODULE_3__["User"]();
        user.id = this.idCurrent;
        console.log(user);
        this.userService.getUserById(user)
            .subscribe(function (data) {
            _this.selectedRole = data.role;
            _this.selectedDepartment = data.department;
            console.log(data);
...
var AppComponent = /** @class */ (function () {
    ...
    Object.defineProperty(AppComponent.prototype, "isSupervisior", {
        get: function () {
    ...
    Object.defineProperty(AppComponent.prototype, "isSubsistent", {
        get: function () {
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.onSubmit = function () {
        ...
        this.authenticationService.login(this.f.username.value, this.f.password.value)
            ...
            console.log("data");
            console.log(data);
            _this.router.navigate(['/' + data.role]);
        }, function (error) {
            _this.error = error;
            _this.loading = false;
        });
...
var SubsistentComponent = /** @class */ (function () {
    function SubsistentComponent(userService) {
        this.userService = userService;
    }
    SubsistentComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    SubsistentComponent.prototype.ngOnChanges = function (changes) {
        var _this = this;
        this.userService.getOnlyUsers()
            .subscribe(function (data) {
            _this.users = data;
    ...
    SubsistentComponent.prototype.activeUser = function (user) {
        var _this = this;
        console.log(user);
        this.userService.activateUsers(user).subscribe(function (data) {
            alert("Φοιτητής Ενεργοποιήθηκε");
            _this.ngOnInit();
        });
    };
    SubsistentComponent.prototype.dActiveUser = function (user) {
        var _this = this;
        console.log(user);
        this.userService.dActivateUsers(user).subscribe(function (data) {
            alert("Φοιτητής Απενεργοποίηση");
            _this.ngOnInit();
        });
    };
    SubsistentComponent.ctorParameters = function () { return [
        { type: _app_services__WEBPACK_IMPORTED_MODULE_2__["UserService"] }
    ]; };
...
var SupervisiorComponent = /** @class */ (function () {
    function SupervisiorComponent(userService) {
        this.userService = userService;
    }
    SupervisiorComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    SupervisiorComponent.prototype.activeRequest = function (request) {
        var _this = this;
        this.userService.activateRequest(request).subscribe(function (data) {
            console.log(data);
            alert("Φοιτητής Εγκρηθηκε");
            _this.ngOnInit();
        });
    };
    SupervisiorComponent.prototype.dActiveRequest = function (request) {
        var _this = this;
        this.userService.dActivateRequest(request).subscribe(function (data) {
            alert("Φοιτητής Εγκρηθηκε");
            _this.ngOnInit();
        });
    };
    SupervisiorComponent.ctorParameters = function () { return [
        { type: _app_services__WEBPACK_IMPORTED_MODULE_2__["UserService"] }
    ]; };
...
var FormComponent = /** @class */ (function () {
    function FormComponent(formBuilder, userService) {
        this.formBuilder = formBuilder;
        this.userService = userService;
        this.loading = false;
        this.submitted = false;
    ...
    FormComponent.prototype.selectChangeHandler = function (event) {
    ...
    FormComponent.prototype.onSubmit = function () {
        ...
        if (!this.isNumeric(this.f.income.value)) {
            ...
            var request = new _app_models__WEBPACK_IMPORTED_MODULE_4__["Application"]();
            ...
            console.log(request);
            this.userService.requestRegister(request).subscribe(function (data) {
                console.log(data);
                if (data) {
                    alert('User updated successfully.');
                }
    ...
    FormComponent.prototype.isNumeric = function (n) {
